/**
 * Composant Footer
 * Footer moderne avec sections complètes
 */
    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-extrabold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              JJFYNE
            </h3>
            <p className="text-gray-400 text-sm mb-6 leading-relaxed">
              Boutique en ligne moderne et élégante. Qualité, style et excellence à chaque clic.
            </p>
